  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment: "Hireful has made the process of searching for a job very simple for me. I was able to look for my dream job within a short period of time and found it. The website is quite simple and the recommendations for jobs are very accurate."
    },
    {
      name: "Michael Chen",
      ...
      rating: 5,
      comment: "The best job search site I've ever experienced. The remote job openings are vast, and the application process is seamless. Would strongly suggest to anyone looking for their next adventure!"
    },
    {
      ...
      rating: 4,
      comment: "Fantastic platform with fantastic customer support. The notification service for employment helped me to keep updated with suitable vacancies. Found an incredible remote job opportunity via Hireful"
    },
    {
      name: "David Thompson",
      ...
      rating: 5,
      comment: "Job Stock is the best among all the other job search websites. The level of the jobs being advertised is excellent, and the search criteria are very comprehensive. Helped me get the job I have now."
    },
    {
      name: "Jessica Lee",
      ...
      rating: 5,
      comment: "Outstanding experience! The UI of the platform is very easy to use, and the matching algorithm for the job is quite impressive. Multiple calls for the interview got placed in a few days of applying."
    },
    {
      ...
      rating: 4,
      comment: "Extremely happy with Job Stock. The range of tech jobs on offer is incredible. The quick apply function was a huge time saver during my job search process."
    }
  ];
